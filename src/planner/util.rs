use crate::{binder::expression::BoundExpr, optimizer::expr_visitor::ExprVisitor};
...
/// Collect all deeply nested Expr::AggregateFunction and Expr::AggregateUDF.
/// They are returned in order of occurrence (depth first), with duplicates
/// omitted.
